...
Label(PageOne, text="Bottle Count: ", font=myfont).grid(row=1, column = 0, padx=(200,0), pady=5, columnspan=2)
Label(PageOne, textvariable=count, font=myfont).grid(row=1, column=2, padx=(0,0), pady=5)
