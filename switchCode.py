...
Label(PageOne, text="Enter your Mobile Number: ", font=myfont).grid(columnspan=2, row=0, column=0, padx=0, pady=5)
...
Button(PageOne, text='2', command=lambda:num_get(2), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=3, column=1)
Button(PageOne, text='3', command=lambda:num_get(3), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=3, column=2)
Button(PageOne, text='4', command=lambda:num_get(4), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=4, column=0)
Button(PageOne, text='5', command=lambda:num_get(5), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=4, column=1)
Button(PageOne, text='6', command=lambda:num_get(6), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=4, column=2)
Button(PageOne, text='7', command=lambda:num_get(7), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=5, column=0)
Button(PageOne, text='8', command=lambda:num_get(8), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=5, column=1)
Button(PageOne, text='9', command=lambda:num_get(9), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=5, column=2)
Button(PageOne, text='0', command=lambda:num_get(0), borderwidth=3, relief=RAISED, height=3, width=5, font=myfont).grid(row=6, column=1)
